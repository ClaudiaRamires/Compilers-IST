...
void fir::frame_size_calculator::do_address_node(fir::address_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_function_decl_node(fir::function_decl_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_indexationptr_node(fir::indexationptr_node *const node, int lvl) {
  // EMPTY
}

void fir::frame_size_calculator::do_memory_reserve_node(fir::memory_reserve_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_declaration_variable_node(fir::declaration_variable_node *const node, int lvl) {
  _localsize += node->type()->size();
}

void fir::frame_size_calculator::do_function_def_node(fir::function_def_node *const node, int lvl) {
  //node->block()->accept(this, lvl + 2);
}

void fir::frame_size_calculator::do_size_of_node(fir::size_of_node *const node, int lvl) {
  // EMPTY
}
